...
<html>
   <head>
      ...
      <title> <?php echo $json_data['qualifications']['title']; ?> </title>
      <meta name="description" content="<?php echo $json_data['qualifications']['description']; ?>">
            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="myDIV">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active" href="qualifications.php"><?php echo $json_data['nav'][2]; ?></a>
                     </li>
                     <li class="nav-item">
            ...
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-md-8 text-center">
                     ...
                     <p class="white">Regional Asphalt Services (RAS) are a highly skilled and passionate team. In the business of laying new and patching existing asphalt surfaces. Our professional services and level of expertise back up our qualifications, ensuring you’ll left satisfied. </p>
                  </div>
               </div>
               <div class="row pb-5 pt-3">
                  <div class="col-md-12">
                     <ul class="qualification-logo mb-0 ps-0">
                        <li><img src="img/DLCSINTERNATIONALLOGO.png" class="img-fluid"></li>
                        <li><img src="img/CivilContractorsFederationlogo.png" class="img-fluid"></li>
                        <li><img src="img/DLCSISOlogos.png" class="img-fluid"></li>
                        <li><img src="img/JAS-ANZ-LOGO.png" class="img-fluid"></li>
                     </ul>
                  </div>
               </div>
               <div class="row">

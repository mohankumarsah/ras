...
<html>
   <head>
      ...
      <title> <?php echo $json_data['projects']['title']; ?> </title>
      <meta name="description" content="<?php echo $json_data['projects']['description']; ?>">
            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="myDIV">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active" href="projects.php"><?php echo $json_data['nav'][3]; ?></a>
                     </li>
                     <li class="nav-item">
         ...
         <div class="project-background">
            <div class="container">
               ...
               <div class="row project-col">
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p1.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 1</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p2.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 2</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p3.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 3</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p4.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 4</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p1.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 5</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p2.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 6</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p3.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 7</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p4.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 8</h3>
                     </a>
                    <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p1.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 9</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p2.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 10</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p3.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 11</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
                  <div class="col-md-3">
                     <a href="">
                        <img src="img/p4.png" class="w-100">
                        <h3 class="project-subtitle orange">Project 12</h3>
                     </a>
                     <div class="text-center"> <img src="img/shadow.png" class="img-fluid"></div>
                  </div>
               </div>
